 ...
 * TestingReversiStuff implementation : © <Your name here> <Your email address here>
 *
 ...
 * states.inc.php
 *
 * TestingReversiStuff game states description
 *
 */
...
$machinestates = array(
    ...
    ST_PLAYER_PLAY_DISC => array(
        ...
        "transitions" => array( "playDisc" => ST_NEXT_PLAYER, "zombiePass" => ST_NEXT_PLAYER, "endGame" => ST_END_GAME)
    ),
